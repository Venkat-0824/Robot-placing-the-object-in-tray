...
class sawyerEnv(gym.Env):
	...
	def reset(self):
		...
		######### repalce tray_x, tray_y with your value #########################
		trayId = p.loadURDF("./tray/tray.urdf", [0.9998008185901645,  0.3, 0], [0, 0, 0, 3])
		######### repalce tray_x, tray_y with your value #########################
		...
		object_path = 'random_urdfs/163/163.urdf'   # change to your assigned object.
